...
function Initialize-Environment {
    ...
    function Setup-WindowsEnvironment {
        ...
        Write-EnhancedLog -Message "Module Path: $global:modulePath"
        Write-EnhancedLog -Message "Repo Path: $global:Repo_Path"
        Write-EnhancedLog -Message "Repo Winget Path: $global:Repo_winget"
    }
...
Write-EnhancedLog -Message "Global variables set by Initialize-Environment:" -Level 'INFO'
...
Write-EnhancedLog -Message "directoryPath: $directoryPath" -Level 'INFO'
