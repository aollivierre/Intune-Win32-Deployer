...
function Uninstall-DattoEDRAgentApplication {
    [CmdletBinding()]
    param()
    ...
    process {
        try {
            $uninstallString = Find-UninstallString -UninstallKeys $uninstallKeys -ApplicationName "*Datto EDR Agent*"
            ...
            if ($null -ne $uninstallString) {
                ...
                # $uninstallStringPostExeUninstall = Find-UninstallString -UninstallKeys $uninstallKeys -ApplicationName "*DattoEDRAgent*"
                ...
                Write-Host "Uninstall string not found for DattoEDRAgent application."
            }
        } catch {
...
function Invoke-Uninstall {
    ...
    if ($UninstallString -like "*Uninstall.exe*") {
        ...
        Start-Process -FilePath $UninstallString -ArgumentList "" -Wait -WindowStyle Hidden
...
Uninstall-DattoEDRAgentApplication
