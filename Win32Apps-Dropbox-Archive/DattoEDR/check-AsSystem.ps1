...
<#
.SYNOPSIS
Checks for the installation of DattoEDRAgent versions older than 3.8.0.1850.

.DESCRIPTION
This script searches the system's uninstallation registry keys for DattoEDRAgent installations. 
It checks if any installed version is older than 3.8.0.1850 and provides feedback based on this condition.
